...
int main()
{
   ...
   //display whether the binary search tree is balanced (should not be balanced)
	...
	if(balanced==true)
		cout<<"/nHeight of the BST is "<<height<<" and the BST is balanced./n";
	else
		cout<<"/nHeight of the BST is "<<height<<" and the BST is unbalanced./n";
   ...
   //display whether the binary search tree is balanced (should be balanced)
	...
	if(balanced==true)
		cout<<"/nHeight of the min BST is "<<height<<" and the BST is balanced./n";
	else
		cout<<"/nHeight of the min BST is "<<height<<" and the BST is unbalanced./n";
   ...
   //display whether the binary search tree is balanced (should be balanced)
	...
	if(balanced==true)
		cout<<"/nHeight of the complete BST is "<<height<<" and the BST is balanced./n";
	else
		cout<<"/nHeight of the complete BST is "<<height<<" and the BST is unbalanced./n";
